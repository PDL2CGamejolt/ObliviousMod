...
class TitleState extends MusicBeatState
{
	...
	public static var updateVersion:String = '1.0';
	...
	override public function create():Void
	{
		...
		if(ClientPrefs.checkForUpdates && !closedState) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/PDL2CGamejolt/VantaEngineNEW/main/version.downloadMe");
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 6:
					...
					#end
				case 8:
					addMoreText('newgrounds and github', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds & GitHub';
				case 9:
					deleteCoolText();
			...
			if (playJingle) //Ignore deez
			{
				...
				switch(easteregg)
				{
					...
					default: //Go back to normal ugly ass boring GF
						...
						FlxG.sound.playMusic(Paths.music('freakyMenu-' + ClientPrefs.daMenuMusic), 100);
						return;
				}
